    ...
    return dedent(
        ...
        Context quickstart:
          ...
          atlas context ranked gn-twelve
            default: curated gn-twelve policy, not a fixed percentage
          atlas context ranked gn-twelve --amount small|medium|large|full|mctx-all
          atlas context ranked gn-twelve --portion 50 --max-tokens 100000
        ...
        Inspect context:
          ...
          atlas context ranked status gn-twelve
          atlas context ranked cache gn-twelve
...
def render_full_dashboard(
    ...
    return dedent(
        ...
        Common Commands:
          ...
          atlas context ranked prepare gn-twelve
          atlas context ranked status gn-twelve
          atlas context ranked plan gn-twelve --amount full
          atlas context ranked cache gn-twelve
          atlas context ranked gn-twelve
